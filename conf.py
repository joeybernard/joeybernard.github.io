...
BLOG_AUTHOR = "Joey Bernard"  # (translatable)
BLOG_TITLE = "Rational Druid"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://joeybernard.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://joeybernard.github.io/"
BLOG_EMAIL = "druid.bernard@gmail.com"
BLOG_DESCRIPTION = "This a site on science, nature and coding."  # (translatable)
